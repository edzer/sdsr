...
_summarises all points_ in the geometry. (More complex options,
...
* **aggregates**: such as sums, totals, averages of fields, counts or densities of objects, associated with lines or regions
...
larger areas, e.g., _averaging_ altitude from 30 m resolution raster
...
if the area to which a value corresponds is cut in parts, the values
...
distributed) or, more realistically, have values that vary around
the mean of the entire area.
...
Both activities involve attributes' relation to geometries and
