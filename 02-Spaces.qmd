...
of units [@SI] consist of seven base units: length (metre,
...
expressed (@fig-ellipse): measured from the center of the ellipse
...
disabling network access to access these grids, and only downloads the section(s)
...
for WGS84 datasets using this axis order. It does not disambiguate
