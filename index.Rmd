...
systems, spatial analysis, and introduce a number of relatively
new packages, including `sf`, `lwgeom`, and `stars`, as well as a
number of `tidyverse` extensions, to do this.
