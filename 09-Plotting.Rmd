...
The use of continuous color scales that have no noticeable color
breaks for continuously varying variables may look attractive,
but is often more fancy than useful:

* it impracticable to match a color on the map with a legend value
