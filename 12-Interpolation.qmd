...
```{r vroom1, message=FALSE, eval=GA}
...
```{r fig-popdens, echo = !knitr::is_latex_output(), eval=GA}
...
```{r fig-no2scat, echo=!knitr::is_latex_output(), eval=GA}
...
```
```{r fig-predictusingpopulationdensity,echo=!knitr::is_latex_output(), eval=GA}
...
```{r fig-residualkriging, echo=!knitr::is_latex_output(), message=FALSE, eval=GA}
