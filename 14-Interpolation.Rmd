...
(ref:condsim) Six conditional simulations for NO$_2$ values

```{r plotkrigingvalues,fig.cap = '(ref:condsim)', echo=!knitr::is_latex_output(), message=FALSE}
library(viridis)
...
5. Compute and show the map with the probability that NO2 point values
exceeds the level of 15 ppm, assuming a normal distribution.
