...
@Diggle:2007; @blangiardo2015spatial; @wikle2019spatio].
...
```{r no2scat, out.width = '50%', fig.cap="Scatter plot of 2017 annual mean NO2 concentration against population density, for rural background air quality stations", eval=TRUE, fig=TRUE, echo=!knitr::is_latex_output()}
