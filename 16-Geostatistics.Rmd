...
(ref:samplevariogram) Spatiotemporal sample variogram for hourly NO$_2$ concentrations at rural background stations in Germany over 2027; in the right-hand side plot color corresponds to time lag.

which is shown in figure \@ref(fig:plotvariograms).
```{r plotvariograms,fig.cap = '(ref:samplevariogram)', echo=!knitr::is_latex_output(), out.height = '160%'}
v1 <- plot(v.st)
