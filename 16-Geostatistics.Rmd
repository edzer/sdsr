...
for which we 75\% of the hourly values measured are valid, i.e. drop
those with more than 25\% hourly values missing. We can do this by
```{r removestationswithmissingvalues}
sel = apply(aq, 2, function(x) mean(is.na(x)) < 0.75)
aqsel = aq[, sel]
```
