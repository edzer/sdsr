...
The pipe that appeared natively in R 4.1.0, `|>`, can be used
anywhere in this book where `%>%` is used. The reason we kept to
the `%>%` pipe is to not exclude users of older R version to use
the code sections in this book.
