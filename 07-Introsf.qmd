...
e = tif.xvec.extract_points(pts, x_coords="x", y_coords="y", name="")
e.name = "L7_ETMs"
...
```
#### Python
```{python fig-rsample, echo=!knitr::is_latex_output()}
# Plot band number 1
ax = tif[1].plot(cmap="gray")
ax = plt.gca()
...
bands, ny, nx = tif.shape
X = tif.values.reshape(bands, ny*nx).T
