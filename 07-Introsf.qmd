...
\index[function]{sf!filter}
\index[function]{sf!select}
\index[function]{sf!group\_by}
\index[function]{sf!ungroup}
\index[function]{sf!mutate}
\index[function]{sf!transmute}
\index[function]{sf!rowwise}
\index[function]{sf!rename}
\index[function]{sf!slice}
\index[function]{sf!summarise}
\index[function]{sf!distinct}
\index[function]{sf!gather}
\index[function]{sf!pivot\_longer}
\index[function]{sf!spread}
\index[function]{sf!nest}
\index[function]{sf!unnest}
\index[function]{sf!unite}
\index[function]{sf!separate}
\index[function]{sf!separate\_rows}
\index[function]{sf!sample\_n}
\index[function]{sf!sample\_frac}
