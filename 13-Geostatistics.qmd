...
#| fig.cap: "Spatiotemporal sample variogram for hourly NO$_2$ concentrations at rural background stations in Germany over 2027; in the right-hand side plot color corresponds to time lag (yellow is later); distance in m."
#| out.width: 80%
#| code-fold: true
v1 <- plot(v.st)
...
as wireframes, shown in @fig-modelwire.  Fitting this model is
...
compare the results.
1. Following the example in the demo scripts pointed at in @sec-cokriging, carry out a cokriging
on the daily mean station data for the four days shown in @fig-stpredictions.  
