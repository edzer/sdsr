...
data(air, package = "spacetime") # load German adm. boundaries
...
#| fig.cap: "Spatiotemporal sample variogram for hourly NO$_2$ concentrations at rural background stations in Germany over 2027; in the right-hand side plot color corresponds to time lag (yellow is later)."
#| out.width: 80%
v1 <- plot(v.st)
...
```
```{r fig-stpredictions, echo=!knitr::is_latex_output()}
