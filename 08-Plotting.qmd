...
possibilities for creating them, and point out challenges along
...
equals one distance unit N-S on the centre of the plotted area,
...
is shown in the centre of a map and what on the fringes, which
...
<!---
Suggest using this instead of two figures. Should we mention the forthcoming 
v4 with changed syntax but support for legacy syntax?
--->
