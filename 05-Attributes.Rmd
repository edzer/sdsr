...
```{r ncaggregation, out.width = '70%', fig.cap="SID74 counts by county quadrant, with county polygons unioned by county quadrant", echo=!knitr::is_latex_output()}
...
```{r ncblocks, out.width = '70%', fig.cap="example target blocks layed out over North Carolina counties", echo=!knitr::is_latex_output()}
...
```{r awiex, out.width = '50%', fig.cap = "example data for area-weighted interpolation", echo = !knitr::is_latex_output()}
