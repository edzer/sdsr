...
the rectangles of figure \@ref(ncblocks) as the target areas, and
...
```{r ncblocks, echo=!knitr::is_latex_output()}
...
available from the target region, with known inclusion probabilities [@brus2021], and
