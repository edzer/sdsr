...
also known as as a variable having _block support_.
...
respect to ellipsoidal coordinate `POINT(-79, 35.5)`) and count
...
nc.grp = st_sf(nc.grp, geom = nc.grp$geometry, sf_column = "geom")
nc.grp$grp = "grouped"
nc$grp = "ungrouped"
n = rbind(nc[c("grp", "SID74")], nc.grp[c("grp", "SID74")])
library(ggplot2)
ggplot() + geom_sf(data = n, aes(fill = SID74)) + facet_wrap(~grp)
```
