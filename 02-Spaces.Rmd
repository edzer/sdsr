...
along an ellispe. If we think of figure \@ref(fig:ellipse) as a
...
altitude is (on the ellipsoid, or on the geoid, approximating mean
sea level?), as well as which direction is positive, and which
direction is "straight up": perpendicular to the spheroid surface,
or in the direction opposite to geoid? All these choices may
