...
The point denoted in figure \@ref(fig:sphere) 
...
```{r horizontalgrid, out.width = '70%', fig.cap="UK horizontal datum grid, from datum OSGB 1936 (EPSG:4277) to datum ETRS89 (EPSG:4258); units arc-seconds", echo=!knitr::is_latex_output(), message = FALSE}
library(stars)
...
```{r verticalgrid, out.width = '70%', fig.cap="UK vertical datum grid, from ETRS89 (EPSG:4937) to ODN height (EPSG:5701), units m", echo=!knitr::is_latex_output(), message = FALSE }
