...
a <- table(addNA(quadr))
locm |>
    hotspot(Prname="Pr(z != E(Ii))", cutoff=0.005, droplevels=FALSE) -> pol_pres15$hs_an_q
locm_p |>
    hotspot(Prname="Pr(z != E(Ii))", cutoff=0.005, droplevels=FALSE) -> pol_pres15$hs_ac_q 
locm_p |> hotspot(Prname="Pr(z != E(Ii)) Sim", cutoff=0.005, droplevels=FALSE) -> pol_pres15$hs_cp_q
...
```{r}
locm_sad_null |> hotspot(Prname="Pr. (Sad)", cutoff=0.005) -> pol_pres15$locm_sad0
locm_sad_null_weights |> hotspot(Prname="Pr. (Sad)", cutoff=0.005) -> pol_pres15$locm_sad1
locm_sad_types |> hotspot(Prname="Pr. (Sad)", cutoff=0.005) -> pol_pres15$locm_sad2
```



```{r fig-localmoranHsad}
#| out.width: 80%
...
```{r}
locm_ex_types |> hotspot(Prname="Pr. (exact)", cutoff=0.005) -> pol_pres15$locm_ex
```


```{r fig-localmoranHsadex}
#| out.width: 80%
...
```{r}
locC_p |> hotspot(Prname="Pr(z != E(Ci)) Sim", cutoff=0.005) -> pol_pres15$hs_C
locG_p |> hotspot(Prname="Pr(z != E(Gi)) Sim", cutoff=0.005) -> pol_pres15$hs_G
```
...
```{r}
locC_p_II |> hotspot(Prname="Pr(z != E(Ci)) Sim", cutoff=0.005) -> pol_pres15$hs_C_II
```
...
```
```{r}
locMvC_p |> hotspot(Prname="Pr(z != E(Ci)) Sim", cutoff=0.005) -> pol_pres15$hs_MvC
```
...
```{r}
locMvC_p |> hotspot(Prname="Pr(folded) Sim", cutoff=0.0025) -> pol_pres15$hs_MvCa
```
