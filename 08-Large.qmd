...
\index{sf\_read!inside bounding box}
...
first attribute by
```{r fig-overpass, fig.cap = "OpenStreetMap vector data"}
...
conventions, being used by the climate and forecast communities.
