...
In general the dataset for model estimation and prediction do not
...
of @sec-lm on this dataset. What has changed?
1. Redo the water-land classification of section @sec-starspredict
using `class::knn` instead of `lda`.
...
the spatial coordinates and compare the results.
