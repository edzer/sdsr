...
values need to be added to the `sf` object, e.g., done using the `nc`
...
total. It is these totals that inform the (Poisson) variability used
by subsequent modelling, e.g., in CAR-type models (@sec-spatglmm).
