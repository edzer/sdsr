...
pol_pres15 |>
    ...
    head()
```
```{r fig-plotpolpres15, out.width='100%', fig=TRUE, echo=TRUE}
...
```{r fig-plotnbdiff, out.width='100%', fig=TRUE}
#| fig.cap: "Triangulated (orange + black) and sphere of influence neighbours (black)"
...
```{r fig-shortestpath, out.width='100%', fig=TRUE, echo=TRUE, message=FALSE}
#| fig.cap: "Relationship of shortest paths to distance for Lutowiska; left panel: shortest path counts from Lutowiska; right panel: plot of shortest paths from Lutowiska to other observations and distances (km) from Lutowiska to other observations"
