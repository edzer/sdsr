...
coordinate values when associated with North American Datum 1927 (NAD27).
...
cell intact, it changes shape and may become rectilinear
(e.g. when going from ellipsoidal coordinates to Mercator, as in
@fig-mapviewfigurepdf)  or curvilinear (e.g. when going from
ellipsoidal coordinates to Lambert Conic Conformal, as in 
@fig-first-map). When reverting this procedure, one can recover
the exact original raster.
