...
An example of an aggregate is the number of births over a given
period of time, of a county.  An example of an identity is a
county name.
...
color value averaged over (an area similar to) a pixel. Most file
...
e.g. a particular data file format, a database, a web service or
a particular compression codec.
