...
#| fig.cap: "A first map: birth rates over North Carolina"
#| code-fold: true
#| fig.height: 4
library(tidyverse)
library(sf)
...
```{r fig-firstgather, fig.cap="ggplot with facet maps", cache=FALSE, echo=!knitr::is_latex_output()}
#| code-fold: true
...
#| fig.cap: "Map obtained by rasterizing county total number of births for the period 1974-1979 shown in figure 1.1"
#| code-fold: true
