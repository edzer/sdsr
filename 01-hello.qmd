...
```{r fig-first-map, out.width = '80%', fig.cap="a first map", eval=TRUE, fig=TRUE, cache=FALSE, message=FALSE, echo=!knitr::is_latex_output()}
#| code-fold: true
library(tidyverse)
library(sf)
...
Before plotting @fig-first-map  we had to read the data,
in this case from a file (@sec-sfintro). Printing a data
