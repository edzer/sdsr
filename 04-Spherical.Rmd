...
5. For `rnaturalearth::ne_countries(country = "Sudan", returnclass="sf")`, check
   whether the geometry is valid on $R^2$, on an orthographic
   projection centered on the country, and on $S^2$.
