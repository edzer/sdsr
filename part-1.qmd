...
contains the hidden R code at the place where it is used in sections
...
problems starts in @sec-part2 of this book. @sec-rbasics contains
a short, elementary explanation of R data structures, @advr gives
an extensive treatment on this.
