...
By reference to [@sfa], chapter 2 of [@asdar] shows where the **sp** spatial 
vector classes, which predate the adoption of simple features, match the **sf**
representations. 

[comment]: FIXME - maybe add table here (MultiPoints, Line, Lines, Polygon, Polygons)
