...
## Simple feature geometries {#simplefeatures}
...
## Coverages: tessellations and rasters {#coverages}
...
4. How can you create a Voronoi diagram (figure \@ref(fig:vor)) that has one closed polygons for every single point?
...
6. Give the DE9-IM relation between `LINESTRING(0 0,1 0)` and `LINESTRING(0.5 0,0.5 1)`; explain the individual characters.
...
9. How would figure \@ref(fig:rasterizeline) look like if $\delta$ for the $y$-coordinate was positive?
