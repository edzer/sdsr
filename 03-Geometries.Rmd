...
for which this is not the case are still considered valid.
...
their inverses) are often not directly intuitive:
...
## Coverages: tesselations and rasters {#geomraster}
