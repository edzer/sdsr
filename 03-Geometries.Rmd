...
```{r sfgeometries,fig.cap = "sketches of the main simple feature geometry types", echo=FALSE}
library(sf)
par(mfrow = c(2,4))
par(mar = c(1,1,1.2,1))
...
```{r de9im,echo=FALSE,fig.cap = "DE-9IM: intersections between the interior, boundary and exterior of a polygon (rows) and of a linestring (columns) indicated by red"}
library(sf)
...
```{r vor, echo=FALSE, out.width='60%', fig.cap="left: convex hull (red) around a polygon (black); right: voronoi diagram (red) from a `MULTIPOINT` (black)"}
