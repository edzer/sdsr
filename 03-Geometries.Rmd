...
of the _first_ geometry (the polygon): figure \@ref(fig:de9im) is
summarised row-wise.
...
```{r rasterizeline, out.width = '60%', fig.cap = "rasterization artifact: as only top-left corners are part of the raster cell, only cells below the diagonal line are rasterized", echo=!knitr::is_latex_output()}
library(stars)
...
@baddeley2015spatial] has infrastructure for analysing point patterns
