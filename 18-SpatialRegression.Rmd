...
nb_q_94a <- poly2nb(boston_94a)
NOX_ID_no_neighs <- boston_94a$NOX_ID[which(card(nb_q_94a) == 0)]
...
nb_q_93 <- poly2nb(boston_93, row.names=unique(as.character(boston_93$NOX_ID)))
```
...
M <- as(nb2listw(nb_q_93, style="B"), "CsparseMatrix")
```
