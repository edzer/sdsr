...
We can start by reading in the 506 tract dataset from **spData** [@R-spData], and creating a contiguity neighbour object and from that again a row standardized spatial weights object. 
```{r, message=FALSE}
library(sf)
library(spData)
...
## Multilevel models of the Boston dataset
